...
class AUSActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        homeBtn.setOnClickListener {
            val intent = Intent(this@AUSActivity, MainActivity::class.java)
            startActivity(intent)
        }

        // take_pointBtn 클릭 시 별점 매기기 화면으로 이동하는 기능 구현
        take_pointBtn.setOnClickListener {
            val intent = Intent(this@AUSActivity, VoteActivity::class.java)
            startActivity(intent)
        }
    }
}
